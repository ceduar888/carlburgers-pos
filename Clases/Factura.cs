...
namespace Clases
{
    public class Factura
    {
        public class CreaTicket
        {
            ...
            public void TextoIzquierda(string par1, string datos)                          // agrega texto a la izquierda
            {
                max = par1.Length;
                if (max > 40)
                {
                ...
                line.AppendLine(ticket = parte1 + datos);
            }
            ...
            public void AgregaArticulo(string Articulo, double precio, int cant, double subtotal)
            {
                if (cant.ToString().Length <= 3 && precio.ToString("c").Length <= 10 && subtotal.ToString("c").Length <= 11)
                {
                    ...
                    {
                        string parteProducto = Articulo.Substring(0, 16);
                        ...
                        line.AppendLine(parteProducto + elementos);
                        Articulo = Articulo.Remove(0, 16);
                    }
                    else
                    {
