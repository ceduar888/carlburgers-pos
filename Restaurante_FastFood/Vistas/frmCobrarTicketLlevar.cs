...
{
    public partial class frmCobrarTicketLlevar : Form
    {
        DataBase_RestaurantEntities Entity = new DataBase_RestaurantEntities();
        private int idEmpleado;
        private int idOrden;

        public frmCobrarTicketLlevar(int empleado, int orden)
        {
            InitializeComponent();
            idEmpleado = empleado;
            idOrden = orden;
        ...
        private void frmCobrarTicketLlevar_Load(object sender, EventArgs e)
        {
