...
{
    public partial class frmCobrarFacturaLlevar : Form
    {
        ...
        public frmCobrarFacturaLlevar(int empleado, int orden, string nomEmpleado, string apeEmpleado, string dEmpleado, string telEmpleado)
        {
            InitializeComponent();
            idEmpleado = empleado;
            codOrden = orden;
            nombreCliente = nomEmpleado;
            apellidoCliente = apeEmpleado;
            duiCliente = dEmpleado;
            telefonoCliente = telEmpleado;
        }

        private void frmCobrarFacturaLlevar_Load(object sender, EventArgs e)
        {
            ...
            txtIdOrden.Text = codOrden.ToString();
