...
{
    public partial class frmMesa3 : Form
    {
        ...
        public frmMesa3(string nombreUsuario, int numMesa)
        {
            InitializeComponent();
        ...
        private void frmMesa3_Load(object sender, EventArgs e)
        {
            dtgvAgregarProductos.ReadOnly = true;
            dtgvPlatillos.ReadOnly = true;

            // TODO: esta línea de código carga datos en la tabla 'dataBase_RestaurantDataSet5.Categoria' Puede moverla o quitarla según sea necesario.
            this.categoriaTableAdapter.Fill(this.dataBase_RestaurantDataSet5.Categoria);
