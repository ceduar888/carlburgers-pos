...
namespace Restaurante_FastFood.Vistas
{
    public partial class frmMesa2 : Form
    {
        ...
        public frmMesa2(string nombreUsuario, int numMesa)
        {
            InitializeComponent();
        ...
        private void frmMesa2_Load(object sender, EventArgs e)
        {
            dtgvAgregarProductos.ReadOnly = true;
            dtgvPlatillos.ReadOnly = true;

            // TODO: esta línea de código carga datos en la tabla 'dataBase_RestaurantDataSet4.Categoria' Puede moverla o quitarla según sea necesario.
            this.categoriaTableAdapter1.Fill(this.dataBase_RestaurantDataSet4.Categoria);
        ...
        private void RegistrarPlatillos()
        {
            try
            {
                ...
                if (respuestaDetallePedido != -1)
                {
                    ...
                    // Mostrar mensaje u otras acciones después de hacer el pedido
                    MessageBox.Show("Pedido registrado con éxito", "Hacer Pedido",
                        MessageBoxButtons.OK, MessageBoxIcon.Information);
