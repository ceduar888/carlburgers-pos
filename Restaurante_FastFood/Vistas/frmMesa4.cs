...
namespace Restaurante_FastFood.Vistas
{
    public partial class frmMesa4 : Form
    {
        ...
        public frmMesa4(string nombreUsuario, int numMesa)
        {
            InitializeComponent();
        ...
        private void frmMesa4_Load(object sender, EventArgs e)
        {
            dtgvAgregarProductos.ReadOnly = true;
            dtgvPlatillos.ReadOnly = true;

            // TODO: esta línea de código carga datos en la tabla 'dataBase_RestaurantDataSet6.Categoria' Puede moverla o quitarla según sea necesario.
            this.categoriaTableAdapter.Fill(this.dataBase_RestaurantDataSet6.Categoria);
