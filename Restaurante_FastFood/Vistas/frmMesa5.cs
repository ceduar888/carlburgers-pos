...
{
    public partial class frmMesa5 : Form
    {
        ...
        public frmMesa5(string nombreUsuario, int numMesa)
        {
            InitializeComponent();
        ...
        private void frmMesa5_Load(object sender, EventArgs e)
        {
            dtgvAgregarProductos.ReadOnly = true;
            dtgvPlatillos.ReadOnly = true;

            // TODO: esta línea de código carga datos en la tabla 'dataBase_RestaurantDataSet7.Categoria' Puede moverla o quitarla según sea necesario.
            this.categoriaTableAdapter.Fill(this.dataBase_RestaurantDataSet7.Categoria);
